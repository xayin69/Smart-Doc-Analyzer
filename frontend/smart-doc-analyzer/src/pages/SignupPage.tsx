...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setSuccess("Registered successfully. Check your email and verify your account first.");
  ...
  return (
    <div className="signup-page min-h-screen w-full relative overflow-hidden flex items-center justify-center p-4">
        ...
        <div className="relative bg-gray-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-800 p-10 w-full">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center px-4 py-2 border border-gray-700 rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-gray-800/50 hover:bg-gray-800 transition-all duration-200"
              >
